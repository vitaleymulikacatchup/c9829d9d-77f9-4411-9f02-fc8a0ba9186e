...
export const metadata: Metadata = {
  title: "Innovate with Your SaaS",
  description: "Transform your business with innovative solutions from Your SaaS.",
  keywords: "SaaS, technology, business solutions, innovation",
  metadataBase: new URL("https://www.yoursaas.com"),
  alternates: { canonical: "https://www.yoursaas.com" },
  openGraph: {
    title: "Innovate with Your SaaS",
    description: "Transform your business with innovative solutions from Your SaaS.",
  ...
  twitter: {
    ...
    title: "Innovate with Your SaaS",
    description: "Transform your business with innovative solutions from Your SaaS.",
    images: ["https://images.pexels.com/photos/1933900/pexels-photo-1933900.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"],
  },
  robots: {
    index: true,
    follow: true
